...
export default function DownloadPage() {
  ...
  const installCommand = "curl -fsSL https://nomisia.net/install_mac.sh | bash";
    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex flex-col items-center justify-center flex-1 text-center px-6">
        ...
        <div className="flex items-center space-x-4 mt-6">
          <div className="text-center download_btn" style={{backgroundColor: "#f0f0f0"}} onClick={() => handleNavigation("/download/mac")}>
        ...
        <div className="mt-6">
          ...
          <p className="text-gray-500 mt-2">Requires macOS 11 Big Sur or later</p>
        </div>
